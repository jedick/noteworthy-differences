...
For example, a product's description is updated frequently but you only want notifications for big changes.
...
- The annotator's labels and rationales are used to align two AI judges
  - The unaligned AI judge has minimal prompt instructions
  - The few-shot AI judge has a prompt with the rationales and labels
    - The classifers' rationales are included in the alignment for additional context
  - The heuristic AI judge has a prompt rewritten in heuristic mode using an LLM
